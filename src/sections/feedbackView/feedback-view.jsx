                          ...
                          {expandedDevices[fb.id] && (
                            <>
                              ...
                              <tr>
                                ...
                                <td>
                                  {fb?.deviceInfo?.deviceType === 1
                                    ? "iOS"
                                    : fb?.deviceInfo?.deviceType === 2
                                      ? "Android"
                                      : "N/A"}
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>{capitalizeName(fb?.deviceInfo?.mobileName) || "N/A"}</td>
                              </tr>
                              {/* App Environment */}
                              <tr>
                                <td className="table-label">App Environment</td>
                                <td>
                                  {fb?.deviceInfo?.appEnvironment ? (
                                    <span
                                      className={`status-badge badge ${fb?.deviceInfo?.appEnvironment === "production"
                                        ? "success-box"
                                        : fb?.deviceInfo?.appEnvironment === "development"
                                          ? "blue-box"
                                          : ""
                                        }`}
                                    >
                                      {capitalizeName(fb?.deviceInfo?.appEnvironment)}
                                    </span>
                                  ) : (
                                    "N/A"
                                  )}
                              ...
                              <tr>
                                ...
                                <td>
                                  {fb?.deviceInfo?.serverEnvironment ? (
                                    <span
                                      className={`status-badge badge ${fb?.deviceInfo?.serverEnvironment === "production"
                                        ? "success-box"
                                        : fb?.deviceInfo?.serverEnvironment === "development"
                                          ? "blue-box"
                                          : ""
                                        }`}
                                    >
                                      {capitalizeName(fb?.deviceInfo?.serverEnvironment)}
                                    </span>
                                  ) : (
                                    "N/A"
                                  )}
