...
import UserTableHead from "../construction-table-head";
import TableEmptyRows from "../table-empty-rows";
import UserTableToolbar from "../construction-table-toolbar";
import { emptyRows, applyFilter } from "../utils";

import AddUserDialog from "../../userView/add-user";
import ConstructionCompanyRow from "../construction-table-row";
            ...
            <div className="page-content notification-page cm-page-panel pt-3">
                <Card className="panel">
                    <div className="panel-heading">
                        <h3 className="panel-title">All Construction Companies</h3>
                    </div>
                                    ...
                                    {!loading &&
                                        dataFiltered.map((row) => (
                                            <ConstructionCompanyRow
                                                ...
                                                appEnvironment={row.appEnvironment}
                                                serverEnvironment={row.serverEnvironment}
